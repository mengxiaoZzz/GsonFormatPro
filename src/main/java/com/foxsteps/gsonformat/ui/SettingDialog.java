...
//        setModal(true);
        ...
        //字段前缀checkbox
        filedPrefixCB.addActionListener(actionEvent -> filedPrefixTF.setEnabled(filedPrefixCB.isSelected()));
        ...
        //Convert Library
        gsonRB.addActionListener(actionEvent -> {
        ...
        jacksonRB.addActionListener(actionEvent -> {
        ...
        loganSquareRB.addActionListener(actionEvent -> {
        ...
        autoValueRB.addActionListener(e -> {
